...
namespace ManageSystem.ControlX
{
    ...
    namespace DesignPatternTest
    {
        public partial class LoadingCircle : Control
        {
            ...
            private const double NumberOfDegreesInCircle = 360;//圆圈
            private const double NumberOfDegreesInHalfCircle = NumberOfDegreesInCircle / 2;//半圈
            private const int DefaultInnerCircleRadius = 8;//默认的内圈半径
            private const int DefaultOuterCircleRadius = 10;//默认的外圈半径
            private const int DefaultNumberOfSpoke = 10;//默认的辐条数量
            private const int DefaultSpokeThickness = 4;//默认的辐条粗细
            private readonly Color DefaultColor = Color.DarkGray;//系统定义的颜色

            private const int MacOSXInnerCircleRadius = 5;//MacOSX浏览器等待加载圆环
            ...
            private const int FireFoxInnerCircleRadius = 6;//FireFox浏览器等待加载圆环
            ...
            private const int IE7InnerCircleRadius = 8;//IE7浏览器等待加载圆环
            ...
            private int m_NumberOfSpoke;//辐条数量
            private int m_SpokeThickness;//辐条粗细
            private int m_ProgressValue;//------------------------
            private int m_OuterCircleRadius;//外圈
            private int m_InnerCircleRadius;//内圈
            private PointF m_CenterPoint;//二维平面的点
            private Color m_Color;
            private Color[] m_Colors;
            private double[] m_Angles;
            private StylePresets m_StylePreset;//枚举的浏览器
